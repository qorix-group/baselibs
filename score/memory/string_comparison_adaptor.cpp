...
StringComparisonAdaptor::StringComparisonAdaptor(const score::cpp::string_view& score_str_view)
    : str_{std::string_view{score_str_view.data(), score_str_view.size()}}
{
}

StringComparisonAdaptor& StringComparisonAdaptor::operator=(const score::cpp::string_view& score_str_view)
{
    str_ = std::string_view{score_str_view.data(), score_str_view.size()};
    return *this;
}
