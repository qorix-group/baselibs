#include "score/datetime_converter/DateTimeConverter.h"
...
using DateTimeType = score::platform::datetime_converter::DateTimeType;
...
TEST_F(DateTimeConverterTest, date_to_epoch_regular_years)
{
    ...
    ASSERT_TRUE(score::platform::datetime_converter::dateTimeToEpoch(dtt1, &epoch));
    ASSERT_EQ(1735787045, epoch);

    std::shared_ptr<DateTimeType> dtt2 = std::make_shared<DateTimeType>(1978, 3, 6, 15, 40, 50);
    ASSERT_TRUE(score::platform::datetime_converter::dateTimeToEpoch(dtt2, &epoch));
    ASSERT_EQ(258046850, epoch);
}

TEST_F(DateTimeConverterTest, epoch_to_date_regular_years)
{
    std::shared_ptr<DateTimeType> dtt1 = score::platform::datetime_converter::epochToDateTime(1735787045);
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(258046850);
...
TEST_F(DateTimeConverterTest, date_to_epoch_leap_years)
{
    ...
    ASSERT_TRUE(score::platform::datetime_converter::dateTimeToEpoch(dtt3, &epoch));
    ASSERT_EQ(1583031845, epoch);
}

TEST_F(DateTimeConverterTest, epoch_to_date_leap_years)
{
    std::shared_ptr<DateTimeType> dtt1 = score::platform::datetime_converter::epochToDateTime(1582859045);
    ASSERT_NE(nullptr, dtt1);
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(1582945445);
    ASSERT_NE(nullptr, dtt2);
    ...
    std::shared_ptr<DateTimeType> dtt3 = score::platform::datetime_converter::epochToDateTime(1583031845);
...
{
    std::shared_ptr<DateTimeType> dtt1 = score::platform::datetime_converter::epochToDateTime(-536360155);
    ASSERT_NE(nullptr, dtt1);
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(-4317783550);
    ASSERT_NE(nullptr, dtt2);
...
{
    std::shared_ptr<DateTimeType> dtt1 = score::platform::datetime_converter::epochToDateTime(-1);
    ASSERT_NE(nullptr, dtt1);
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(0);
    ASSERT_NE(nullptr, dtt2);
    ...
    std::shared_ptr<DateTimeType> dtt3 = score::platform::datetime_converter::epochToDateTime(1);
    ASSERT_NE(nullptr, dtt3);
...
{
    std::shared_ptr<DateTimeType> dtt1 = score::platform::datetime_converter::epochToDateTime(-4728574555);
    ASSERT_NE(nullptr, dtt1);
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(-4728488155);
    ASSERT_NE(nullptr, dtt2);
    ...
    std::shared_ptr<DateTimeType> dtt3 = score::platform::datetime_converter::epochToDateTime(-4728401755);
    ASSERT_NE(nullptr, dtt3);
...
{
    std::shared_ptr<DateTimeType> dtt5 = score::platform::datetime_converter::epochToDateTime(-2067368155);
    ...
    std::shared_ptr<DateTimeType> dtt6 = score::platform::datetime_converter::epochToDateTime(-2080500955);
...
TEST_F(DateTimeConverterTest, epoch_to_date_random_cases)
{
    ...
    std::shared_ptr<DateTimeType> dtt2 = score::platform::datetime_converter::epochToDateTime(-2043780955);
    ASSERT_NE(nullptr, dtt2);
    ...
    std::shared_ptr<DateTimeType> dtt3 = score::platform::datetime_converter::epochToDateTime(-2014664155);
    ASSERT_NE(nullptr, dtt3);
    ...
    std::shared_ptr<DateTimeType> dtt4 = score::platform::datetime_converter::epochToDateTime(-1815290254);
    ...
    std::shared_ptr<DateTimeType> dtt5 = score::platform::datetime_converter::epochToDateTime(946684800);
    ASSERT_NE(nullptr, dtt5);
    ...
    std::shared_ptr<DateTimeType> dtt6 = score::platform::datetime_converter::epochToDateTime(-2208988800);
    ASSERT_NE(nullptr, dtt6);
    ...
    std::shared_ptr<DateTimeType> dtt7 = score::platform::datetime_converter::epochToDateTime(-2177452800);
    ...
    std::shared_ptr<DateTimeType> dtt8 = score::platform::datetime_converter::epochToDateTime(1580180645);
    ...
    std::shared_ptr<DateTimeType> dtt9 = score::platform::datetime_converter::epochToDateTime(1585364645);
...
TEST_F(DateTimeConverterTest, test_if_datetime_format_is_correct)
{
    ...
    ASSERT_TRUE(score::platform::datetime_converter::isValidDateTimeFormat(dtt));
    dtt->m_year = 2;
    ASSERT_FALSE(score::platform::datetime_converter::isValidDateTimeFormat(dtt));
...
{
    ASSERT_FALSE(score::platform::datetime_converter::yearIsLeap(1999));
    ASSERT_TRUE(score::platform::datetime_converter::yearIsLeap(2000));
    ASSERT_TRUE(score::platform::datetime_converter::yearIsLeap(2004));

    ASSERT_FALSE(score::platform::datetime_converter::yearIsLeap(1900));
    ASSERT_FALSE(score::platform::datetime_converter::yearIsLeap(2100));
}
