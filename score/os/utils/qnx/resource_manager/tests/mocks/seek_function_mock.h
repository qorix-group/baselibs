...
#ifndef BASELIBS_SCORE_OS_QNX_RESOURCE_TEST_LSEEK_HANDLER_INTERFACE_MOCK_H
#define BASELIBS_SCORE_OS_QNX_RESOURCE_TEST_LSEEK_HANDLER_INTERFACE_MOCK_H
...
#endif  // BASELIBS_SCORE_OS_QNX_RESOURCE_TEST_LSEEK_HANDLER_INTERFACE_MOCK_H
