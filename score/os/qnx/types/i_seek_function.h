...
#ifndef BASELIBS_SCORE_OS_QNX_RESOURCE_LSEEK_HANDLER_INTERFACE_H
#define BASELIBS_SCORE_OS_QNX_RESOURCE_LSEEK_HANDLER_INTERFACE_H
...
#endif  // BASELIBS_SCORE_OS_QNX_RESOURCE_LSEEK_HANDLER_INTERFACE_H
