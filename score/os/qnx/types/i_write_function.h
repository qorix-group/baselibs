...
#ifndef BASELIBS_SCORE_OS_QNX_RESOURCE_WRITE_HANDLER_INTERFACE_H
#define BASELIBS_SCORE_OS_QNX_RESOURCE_WRITE_HANDLER_INTERFACE_H
...
#endif  // BASELIBS_SCORE_OS_QNX_RESOURCE_WRITE_HANDLER_INTERFACE_H
