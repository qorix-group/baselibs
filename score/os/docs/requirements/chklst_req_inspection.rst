...
.. document:: OS Requirements Inspection Checklist
   :id: doc__os_req_inspection
   :status: draft
   :version: 1
   :safety: ASIL_B
   :security: YES
...
.. needtable::
   :filter: "os" in docname and "requirements" in docname and docname is not None and status == "valid"
   :style: table
   :types: comp_req
   :tags: os
