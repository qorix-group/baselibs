...
#ifndef BASELIBS_SCORE_JSON_INTERNAL_PARSER_NLOHMANN_JSON_BUILDER_H
#define BASELIBS_SCORE_JSON_INTERNAL_PARSER_NLOHMANN_JSON_BUILDER_H
...
#endif  // BASELIBS_SCORE_JSON_INTERNAL_PARSER_NLOHMANN_JSON_BUILDER_H
