...
TEST_F(ErrorDomainTest, kImplicitRounding)
{
    verifyErrorMessage(ErrorCode::kImplicitRounding, "Operation implicitly rounds result");
}

TEST_F(ErrorDomainTest, kDivideByZero)
{
    verifyErrorMessage(ErrorCode::kDivideByZero, "Division by zero");
}
