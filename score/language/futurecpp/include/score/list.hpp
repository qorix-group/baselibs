...
///
/// \brief Score.Futurecpp.List component
///

#ifndef SCORE_LANGUAGE_FUTURECPP_LIST_HPP
#define SCORE_LANGUAGE_FUTURECPP_LIST_HPP
...
template <class T>
using list = std::list<T, score::cpp::pmr::polymorphic_allocator<T>>;

} // namespace pmr
} // namespace score::cpp

#endif // SCORE_LANGUAGE_FUTURECPP_LIST_HPP
