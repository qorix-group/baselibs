...
#define SCORE_LANGUAGE_FUTURECPP_UNREACHABLE() SCORE_LANGUAGE_FUTURECPP_INTERNAL_HELPER_DUMMY_FOR_SEMICOLON
#define SCORE_LANGUAGE_FUTURECPP_UNREACHABLE_MESSAGE(msg) SCORE_LANGUAGE_FUTURECPP_INTERNAL_HELPER_DUMMY_FOR_SEMICOLON
#else
...
/// This check will not be compiled if `SCORE_LANGUAGE_FUTURECPP_ASSERT_LEVEL_PRODUCTION` is defined.
///
#define SCORE_LANGUAGE_FUTURECPP_UNREACHABLE() SCORE_LANGUAGE_FUTURECPP_INTERNAL_UNREACHABLE_IMPL(nullptr)
