...
/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial)
{
    static_assert(std::is_trivially_copy_constructible_v<score::cpp::inplace_vector<std::int32_t, 2>>);
    static_assert(std::is_trivially_copy_assignable_v<score::cpp::inplace_vector<std::int32_t, 2>>);
    static_assert(std::is_trivially_move_constructible_v<score::cpp::inplace_vector<std::int32_t, 2>>);
    static_assert(std::is_trivially_move_assignable_v<score::cpp::inplace_vector<std::int32_t, 2>>);
    static_assert(std::is_trivially_destructible_v<score::cpp::inplace_vector<std::int32_t, 2>>);
}

/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial_copy_constructible)
{
    ...
    static_assert(std::is_trivially_copy_constructible_v<score::cpp::inplace_vector<trivial_copy_only, 2>>);
}

/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial_move_constructible)
{
    ...
    static_assert(std::is_trivially_move_constructible_v<score::cpp::inplace_vector<trivial_move_only, 2>>);
}

/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial_copy_assignable)
{
    {
        ...
        static_assert(std::is_trivially_copy_assignable_v<score::cpp::inplace_vector<trivial_copy_assignable, 2>>);
    }
    {
        ...
        static_assert(!std::is_trivially_copy_assignable_v<score::cpp::inplace_vector<not_trivial_copy_assignable, 2>>);
    }
    {
        struct not_trivial_copy_assignable
        {
...
/// @testmethods TM_REQUIREMENT
/// @requirement CB-#17893146
TEST(inplace_vector_test, trivial_move_assignable)
{
    {
        ...
        static_assert(std::is_trivially_move_assignable_v<score::cpp::inplace_vector<trivial_move_assignable, 2>>);
    }
    {
        ...
        static_assert(!std::is_trivially_move_assignable_v<score::cpp::inplace_vector<not_trivial_move_assignable, 2>>);
    }
    {
        struct not_trivial_move_assignable
        {
